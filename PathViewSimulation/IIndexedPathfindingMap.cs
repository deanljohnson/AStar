...
namespace PathViewSimulation
{
    public interface IIndexedPathfindingMap : Drawable
    {
        ...
        /// </summary>
        List<Vector2i> GetNeighbors(Vector2i cell);

        /// <summary>
        /// Returns neighbors of the given cell that are traversable,
        /// pruning based on the direction of travel for Jump Point Search.
        /// </summary>
        List<Vector2i> GetJPSPrunedNeighbors(Vector2i current, Vector2i previous);
