...
{
    internal class Grid : Transformable, Drawable
    {
        ...
        public Grid(Vector2i cellSize, Vector2i gridSize)
        {
            GridSize = gridSize;
            CellSize = cellSize;
        ...
        public void SetColorOfCell(int x, int y, Color color)
        {
            var i = (uint)((x + (y * GridSize.X)) * 4);
        ...
        public void SetColorOfCell(Vector2i i, Color color)
        {
        ...
        public void ClearCellColors(Color color)
        {
